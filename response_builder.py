...
def _build_answer_system_prompt(
    *,
    ...
    return (
        ...
        "YOUR TASK:\n"
        "Write a complete, well-structured answer to the original question. "
        "Follow these rules STRICTLY:\n\n"
        "WRITING RULES:\n"
        "1. Write a COMPLETE answer \u2014 do NOT cut off mid-thought.\n"
        "2. Use 2-4 short paragraphs (each 2-4 sentences).\n"
        "3. Match the tone implied by the persona block above.\n"
        "4. Every factual claim must come from the RAG context. "
        "If something is not in the context, do not state it as fact.\n"
        "5. End with a natural closing sentence \u2014 NOT a question.\n"
        f"6. Length: {length_hint}.\n"
        "7. Do NOT include generic disclaimers like 'consult a doctor'. "
        "Kalpana redirects via the next-step suggestions that get added afterwards.\n\n"
        "OUTPUT FORMAT:\n"
        "Plain prose only. NO markdown headers. NO JSON. NO bullet points unless content truly demands them. "
        "Write as if you're talking to her, not formatting a document.\n\n"
